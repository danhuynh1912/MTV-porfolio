    ...
    >
      {items.map((item) => (
        ...
        >
          ...
          <p className='mt-2 shrink-0 text-[12px] text-ink-soft'>
            {item.caption}
          </p>
        </div>
      ))}
        ...
        <div className='mt-12 flex gap-4 h-max w-fit m-auto'>
          <Col
            ...
            items={[
              {
                src: imgTakashimaya,
                caption: 'Takashimaya S.C Website',
                delay: 0.25,
              },
            ]}
            flex={2}
          ...
          <Col
            delay={0.4}
            items={[
              { src: imgFinTouch, caption: 'Fin-Touch Mobile App', delay: 0.4 },
            ]}
          />
        </div>
      </motion.section>
